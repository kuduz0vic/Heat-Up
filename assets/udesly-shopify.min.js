        ...
        !(function (e) {
          ...
          (e.compile = g),
            ...
            (e.renderAsync = function (e, t, r, n) {
              return $(e, t, Object.assign({}, r, { async: !0 }), n);
            }),
            (e.templates = f),
    ...
    _updateVariationProps() {
      ...
      this.skus.forEach((e) => {
        ...
        this.unitPrices.forEach((e) => {
          e.innerHTML = w(this.variation.unit_price);
        }),
        this.prices.forEach((e) => {
          e.innerHTML = w(this.variation.price);
        }),
        ...
        this.moreImages.forEach((t) => {
          if (t.templateEmpty && t.templateList && t.templateItem) {
            if (!t.templateItemFunction) {
              var r = t.templateItem
                .cloneNode(!0)
                .outerHTML.replace(/{#(.*?)#}/gm, function (e, t) {
                  return (
                    (t = t
                      .trim()
            ...
            if (((t.innerHTML = ""), e.length)) {
              var n = t.templateList.cloneNode(),
                o = "";
              for (var i of e) o += t.templateItemFunction(i);
              (n.innerHTML = o), t.append(n);
    ...
    Re = (e, t, r) => {
      try {
        if (
          ...
          if (W || R) {
            if (H) return Promise.resolve(t).then((t) => qe(e, t));
            qe(e, t);
